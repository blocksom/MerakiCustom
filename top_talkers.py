...
# Change 'apikey' variable to match ICU Medical Meraki Organization
                    ...
                    for client in clients:
                        ...
                        # Graceful failover
                            ...
                            if traffic:
                                ...
                                network_dict = {'Network Name':net['name'], 'Network ID':net['id'], 'DNS Request Quantity':len(traffic)}
...
# Script Driver to execute Top Talkers project and calculate program runtime
